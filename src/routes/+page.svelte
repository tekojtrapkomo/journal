<script>
    const dates = [
        ...
        { day: "october 31", href: "/october-31", active: false },
        ...
        const itemsPerColumn = Math.ceil(dates.length / 3);
  ...
  <div class="wrapper">
    <div class="header">
      <div class="left">
        ...
        <img src="/sub2.png" alt="subtitle">
      </div>
      <div class="right">
        <img class="right-img" src="/right.png" alt="right">
        <img class="halo" src="/halo.png" alt="halo">
      </div>
    </div>
